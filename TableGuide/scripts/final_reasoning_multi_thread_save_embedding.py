...
def get_embedding_for_table(table, table_embedding_map):
...
def process_single_table(index, d, row_prompt, col_prompt, plan_prompt, final_reasoning_prompt, noplan_reasoning_prompt, question_type_map, table_embedding_map):
    ...
    table_embeddings = get_embedding_for_table(table, table_embedding_map)
...
def main():
    with open("dataset/wikitq/valid/3072-4096/3072-4096.jsonl", 'r') as f:
        data = f.readlines()
    ...
    with open("prompt/final_reasoning_DAG.md", "r") as f:
